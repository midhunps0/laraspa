<button x-data="{navcollapsed: $persist(false)}"
        ...
        " class="hidden md:inline-block btn btn-sm btn-outline fixed bottom-3 right-3 z-50" :class="!navcollapsed || 'text-warning'" @click.prevent.stop="navcollapsed = !navcollapsed; $dispatch('navresize', {navcollapsed: navcollapsed});">
