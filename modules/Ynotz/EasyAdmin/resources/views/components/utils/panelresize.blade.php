<button x-data="{navcollapsed: $persist(false)}"
        ...
        " class="hidden md:inline-block btn btn-sm btn-outline" :class="!navcollapsed || 'text-warning'" @click.prevent.stop="navcollapsed = !navcollapsed; $dispatch('navresize', {navcollapsed: navcollapsed});">
